...
<body>
    <form id="form1" runat="server">
        Select a Country:<asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="CountriesDataSource" DataTextField="Country" DataValueField="Country">
            <asp:ListItem Value="" Text="Select a Country"></asp:ListItem>
        </asp:DropDownList>
        <asp:SqlDataSource ID="CountriesDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:northwindConnectionString %>" SelectCommand="SELECT DISTINCT [Country] FROM [Customers]"></asp:SqlDataSource>
